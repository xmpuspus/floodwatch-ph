...
![FloodWatch.PH: the Corridor watch tiered observation surface over the expressways, the rainfall heartbeat with per-layer freshness clocks, the area and route evidence lookup, and the Super Typhoon Carina 2024 time series](docs/screenshots/hero.gif)
